...
?>
    <div class="publications-detail-quiz test1">
        <div class="publications-detail-quiz__start">
            <div class="row">
                <div class="col">
                    <p class="h3">Могут ли вас привлечь к субсидиарной ответственности?</p>
        ...
        <div class="publications-detail-quiz__body d-none">
            <p class="publications-detail-quiz__title">
            </p>
            <hr class="publications-detail-quiz__hr d-none">
            ...
            <div class="publications-detail-quiz__container">
                ...
                <div class="publications-detail-quiz__question-container d-none end">
                    ...
                    <p class="publications-detail-quiz__question">
                        Оставьте свой email, чтобы <strong>получить видео "32 стратегии взыскания
                            задолженности"</strong> и подробный план,
...
?>
    <div class="publications-detail-quiz test2">
        <div class="publications-detail-quiz__start">
            <div class="row">
                <div class="col">
                    <p class="h3">Определите вероятность взыскания дебиторки с вашего должника</p>
                    <p>Ответив на 11 вопросов, вы получите экспертную оценку права требования и вероятности его
