                    ...
                    <? foreach ($arResult["DISPLAY_PROPERTIES"]["BX_NEWS_BANNERS"]["VALUE"] as $key => $value): ?>
                        <? if ($arResult["DISPLAY_PROPERTIES"]["BX_NEWS_BANNERS"]["DESCRIPTION"][$key]): ?>
                            <div class="news-detail-banner">
                                <a href="<?= $arResult['DISPLAY_PROPERTIES']['BX_NEWS_BANNERS']['DESCRIPTION'][$key]; ?>"
                                   target="_blank">
            ...
            <div class="news-detail-text">
                ...
                <div class="news-detail-author">
                    <div class="row">
                        ...
                        <div class="col">
                            <p class="news-detail-author__title text-md-left text-center">
                                Рыков Иван
                            </p>
                            <p class="news-detail-author__description ml-md-0 mr-md-0 ml-auto mr-auto text-md-left text-center">
                                Основатель антикризисной юридической компании «Рыков групп»
                            </p>
                            <p class="news-detail-author__spec">
